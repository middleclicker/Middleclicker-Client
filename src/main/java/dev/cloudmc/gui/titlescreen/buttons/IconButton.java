...
public class IconButton {
    ...
    public void renderButton(int x, int y, int mouseX, int mouseY, int color) {
        this.x = x;
        this.y = y;
        ...
        Helper2D.drawPicture(x, y, w, h, color, "icon/" + icon);
    }

    public void renderButton(int x, int y, int mouseX, int mouseY, int color, int imgW, int imgH) {
        this.x = x;
        this.y = y;
        ...
        Helper2D.drawPicture(x+imgW/2, y+imgH/2, imgW, imgH, color, "icon/" + icon);
    }
